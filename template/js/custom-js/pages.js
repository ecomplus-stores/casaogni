...
document.addEventListener("DOMContentLoaded", function() {
  ...
  $('.header__search#search-form .header__search-input').keyup(function(){
...
const searchFormInput = searchForm.querySelector("input"); // <=> document.querySelector
...
if(SpeechRecognition) {
  ...
  searchForm.insertAdjacentHTML("afterbegin", '<button type="button"><svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19.6068 10V12C19.6068 15.866 16.4728 19 12.6068 19M5.60681 10V12C5.60681 15.866 8.74082 19 12.6068 19M12.6068 19V22M8.60681 22H16.6068M12.6068 15C10.95 15 9.60681 13.6569 9.60681 12V5C9.60681 3.34315 10.95 2 12.6068 2C14.2637 2 15.6068 3.34315 15.6068 5V12C15.6068 13.6569 14.2637 15 12.6068 15Z" stroke="#AA644B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>');
  ...
  function resultOfSpeechRecognition(event) {
    ...
    if(transcript.toLowerCase().trim()==="stop recording") {
      ...
      console.log(`Busca por voz:`,transcript)
    }
    else {
...
async function placeFavorites(){  
  ...
  try {
    ...
    search.setProductIds(favoriteList).fetch().then(result => {
      ...
      $(`#favorites-toggle span`).text(result.hits.hits.length)
    })
